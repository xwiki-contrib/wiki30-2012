...
public class WikiManagerMessageTool extends XWikiPluginMessageTool
{
    ...
    /**
     * Used as {@link org.apache.commons.logging.Log} log message when wiki edit rights check failed.
     */
    public static final String LOG_MANAGERCANEDIT = "wikimanager.plugin.log.managercanedit";
    
    /**
     * Used as {@link org.apache.commons.logging.Log} log message when wiki deletion rights check failed.
     */
    public static final String LOG_MANAGERCANDELETE = "wikimanager.plugin.log.managercandelete";
