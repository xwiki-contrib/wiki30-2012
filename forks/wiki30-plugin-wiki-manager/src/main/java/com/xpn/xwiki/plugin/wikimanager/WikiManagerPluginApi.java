...
public class WikiManagerPluginApi extends PluginApi<WikiManagerPlugin>
{
    ...
    /**
     * @return true if the it's possible for the current user to create a new wiki
     */
    public boolean canCreateWiki()
    {
        return this.wikiManager.canCreateWiki(this.context.getUser(), this.context);
    }

    /**
     * @param userName name of the user to check
     * @return true if the it's possible for the specified user to create a new wiki
     */
    public boolean canCreateWiki(String userName)
    {
        return this.wikiManager.canCreateWiki(userName, this.context);
    }

    /**
     * @param wikiName name of the wiki to check
     * @return true if the it's possible for the current user to edit the wiki descriptor of the specified wiki
     */
    public boolean canEditWiki(String wikiName)
    {
        return this.canEditWiki(wikiName, this.context.getUser());
    }

    /**
     * @param wikiName name of the wiki to check
     * @param userName name of the user to check
     * @return true if the it's possible for the specified user to edit the wiki descriptor of the specified wiki
     */
    public boolean canEditWiki(String wikiName, String userName)
    {
        return this.wikiManager.canDeleteWiki(wikiName, userName, this.context);
    }

    /**
     * @param wikiName name of the wiki to check
     * @return true if the it's possible for the current user to delete a wiki
     */
    public boolean canDeleteWiki(String wikiName)
    {
        return this.canDeleteWiki(wikiName, context.getUser());
    }

    /**
     * @param wikiName name of the wiki to check
     * @param userName name of the user to check
     * @return true if the it's possible to the specified user to delete the specified wiki
     */
    public boolean canDeleteWiki(String wikiName, String userName)
    {
        return this.wikiManager.canEditWiki(wikiName, userName, this.context);
    }
